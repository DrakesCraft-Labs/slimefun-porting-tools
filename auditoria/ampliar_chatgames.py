...
REACTION_NUEVAS = [
    ...
    ("Comando de bovedas", "Comando de tus bovedas, SIN la barra: <yellow>pv</yellow>", "pv"),
    ("Comando de subasta", "Comando del mercado, SIN la barra: <yellow>ah</yellow>", "ah"),
    ("Comando de guia SF", "Comando de la guia, SIN la barra: <yellow>sf guide</yellow>", "sf guide"),
    ("Comando de warps", "Comando de warps, SIN la barra: <yellow>pwarp</yellow>", "pwarp"),
